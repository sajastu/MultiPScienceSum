...
from .configuration_bart import LEDConfig
...
class FlaxBartPreTrainedModel(FlaxPreTrainedModel):
    ...
    @replace_return_docstrings(output_type=FlaxBaseModelOutput, config_class=LEDConfig)
    def encode(
        self,
    ...
    @replace_return_docstrings(output_type=FlaxBaseModelOutputWithPastAndCrossAttentions, config_class=LEDConfig)
    def decode(
        self,
        decoder_input_ids,
        encoder_outputs,
...
class FlaxBartForConditionalGeneration(FlaxBartPreTrainedModel):
    ...
    @add_start_docstrings(BART_DECODE_INPUTS_DOCSTRING)
    @replace_return_docstrings(output_type=FlaxCausalLMOutputWithCrossAttentions, config_class=LEDConfig)
    def decode(
        self,
        decoder_input_ids,
        encoder_outputs,
